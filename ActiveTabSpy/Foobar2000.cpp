...
extern "C" __declspec(dllexport) void inspectActiveTabOnFoobar2000(HWND hWnd, int isHorizontal, int* pointX, int* pointY, int* left, int* right, int* top, int* bottom) {
